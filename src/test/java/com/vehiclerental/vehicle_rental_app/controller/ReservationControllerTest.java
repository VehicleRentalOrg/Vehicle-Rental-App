...
class ReservationControllerTest {
    ...
    void getAllReservations_shouldReturnOk() throws Exception {
        ...
        Vehicle vehicle2 = new Vehicle("V002", "Ford", 2022, "Black", "VIN0987654321", VehicleType.SUV, VehicleStatus.MAINTENANCE, "Navigation, Heated Seats", 12000);
        ...
        Reservation reservation1 = new Reservation("R001", LocalDateTime.of(2025, 7, 28, 10, 0), LocalDateTime.of(2025, 7, 30, 10, 0), "New York", "Boston", vehicle1, employee1, customer1, ReservationType.ONLINE, ReservationStatus.BOOKED, true);

        Reservation reservation2 = new Reservation("R002", LocalDateTime.of(2025, 8, 5, 9, 0), LocalDateTime.of(2025, 8, 7, 18, 0), "San Francisco", "Los Angeles", vehicle2, employee2, customer2, ReservationType.WALK_IN, ReservationStatus.CANCELLED, false);
    ...
    void getReservationById_shouldReturnOk() throws Exception {
        ...
        Reservation reservation = new Reservation("R002", LocalDateTime.of(2025, 8, 5, 9, 0), LocalDateTime.of(2025, 8, 7, 18, 0), "San Francisco", "Los Angeles", vehicle2, emp1, customer2, ReservationType.WALK_IN, ReservationStatus.CANCELLED, false);
